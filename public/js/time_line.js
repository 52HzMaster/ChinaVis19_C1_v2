...
time_line_(day1data,day1alive,0);

function time_line_(day_data,day_alive,index){

    time_line.myChart = echarts.init(document.getElementById('plot'));
